                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Row(
                      ...
                      children: [
                        Text('Languages', style: Theme.of(context).textTheme.bodyText1),
                        Icon(
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Privacy Policy', style: Theme.of(context).textTheme.bodyText1),
                        Icon(
                          Icons.arrow_forward_ios_sharp,
                          size: 20,
                          color: Colors.black,
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Terms & Condition', style: Theme.of(context).textTheme.bodyText1),
                        Icon(
                          Icons.arrow_forward_ios_sharp,
                          size: 20,
                          color: Colors.black,
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Love the app? Rate us', style: Theme.of(context).textTheme.bodyText1),
                        Icon(
                          Icons.arrow_forward_ios_sharp,
                          size: 20,
                          color: Colors.black,
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('About Us', style: Theme.of(context).textTheme.bodyText1),
                        Icon(
                          Icons.arrow_forward_ios_sharp,
                          size: 20,
                          color: Colors.black,
