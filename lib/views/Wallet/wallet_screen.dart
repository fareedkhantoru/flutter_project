          ...
          children: [
            ...
            Expanded(
              ...
              child: DefaultTabController(
                ...
                child: Column(
                  children: [
                    TabBar(onTap: (int index) async {}, indicatorColor: Theme.of(context).primaryColor, unselectedLabelColor: Theme.of(context).primaryTextTheme.headline3.color, indicatorSize: TabBarIndicatorSize.tab, labelColor: Theme.of(context).primaryColor, labelStyle: Theme.of(context).textTheme.headline5, tabs: [
                      Tab(
                        child: Text(
                          'Summary',
                        ),
            ...
            child: Padding(
              ...
              child: Card(
                child: ListTile(
                  ...
                  subtitle: Text('${global.currencySymbol}300', style: Theme.of(context).primaryTextTheme.headline2),
