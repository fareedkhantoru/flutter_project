...
class UploadDocumentBLScreen extends BaseRoute {
  ...
  //o - observer
  UploadDocumentBLScreen({a, o})
      : super(a: a, o: o, r: 'UploadDocumentBLScreen');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: CommonPadding(
          child: GetBuilder<BusinessLoanController>(builder: (controller) {
        return PrimaryTextButton(
          text: 'Next',
          voidCallback: () {
            if (businessLoanController.companyTypeVal == 'Partnership' ||
                        ...
                        Padding(
                            ...
                            child: DottedBorder(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  imagePickerSheet(
                                      'Photo of Prop/Indi', context, null);
                                },
                                child: Container(
                                  width: Get.width,
                                  height: 250,
                                  child: ImageWidget(
                                    file:
                                        businessLoanController.photoOfPropIndi,
                            ...
                            child: DottedBorder(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: ImageWidget(
                                    file:
                                        businessLoanController.electricityBill,
                            ...
                            child: DottedBorder(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: ImageWidget(
                                    file:
                                        businessLoanController.gstRegistration,
                                ...
                                child: DottedBorder(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      height: 250,
                                      child: ImageWidget(
                                        file: businessLoanController
                                            .panCardPartnershipFirm,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                          ...
                                          child: CustomDropDown(
                                            ...
                                            list:
                                                businessLoanController.yearList,
                                            onChanged: (selectedValue) {
                                              businessLoanController
                                                      .firstYearOfITReturnVal =
                                                  selectedValue.toString();
                                            },
                                            val: businessLoanController
                                                .firstYearOfITReturnVal,
                                          )),
                                      Container(
                                        width: Get.width,
                                    ...
                                    child: DottedBorder(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: ImageWidget(
                                            file:
                                                businessLoanController.panCard,
                                            name: 'PAN card',
                                          ),
                                        ),
                                      ),
