...
class DirectorListEntryBLScreen extends BaseRoute {
  DirectorListEntryBLScreen({a, o})
      : super(a: a, o: o, r: 'DirectorListEntryBLScreen');
                    ...
                    child: CustomDropDown(
                      ...
                      onChanged: (selectedValue) {
                        businessLoanController
                            .setNumberValForDirector(selectedValue.toString());
                        businessLoanController.setDirectorListController(
                ...
                GetBuilder<BusinessLoanController>(builder: (controller) {
                  return businessLoanController.numberValForDirector != null
                      ? ListView.builder(
                          ...
                          itemCount: int.parse(businessLoanController
                              .numberValForDirector
                              .toString()),
                          itemBuilder: (BuildContext context, int index) {
                            return Column(
                              children: [
                                businessLoanController.numberValForDirector !=
                                        null
                                    ? Container(
                                        width: Get.width,
                                        child: Padding(
                                ...
                                Padding(
                                  ...
                                  child: CustomTextFormField(
                                    ...
                                    textEditingController:
                                        businessLoanController
                                            .cDirectorPhoneNumberList[index],
                                    obscureText: false,
                                    textInputType:
