                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text('No', style: Theme.of(context).primaryTextTheme.headline3)
                            ],
                          ),
                        ],
                      );
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text('Single', style: Theme.of(context).primaryTextTheme.headline3)
                      ],
                    ),
                    Row(
                      children: [
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text('These details are subject to verification', style: Theme.of(context).primaryTextTheme.headline3),
            ),
            Container(
              width: Get.width,
              child: Padding(
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.only(top: 15),
                                  child: Text('Work Address', style: Theme.of(context).primaryTextTheme.headline1),
                                ),
                              ),
                              Container(
                                width: Get.width,
